...
for %%v in ("%~1\*%~2") do csm "%%v" -outfile=ContactSheets\{title}.jpg -border=2 -cover=true -cfill=true -cmaxw=45 -width=1920 -cols=8 -qual=90 -header=true -hsize=24 -hstats=true 